...
The difficulty is not global, since domains could have different maximum throughputs, 
...
DDoSCoin adjusts diffuculty for a given domain as a function of the total number 
of blocks mined, rather than the number of blocks mined by targetting that domain. 
This allows target domains that somehow become more difficult to reach to quickly 
return to a more appropriate difficulty, without having many blocks mined at the 
high difficulty. This comes at a sacrifice to the agility of corrections when a 
domain has too low of a difficulty. This allows a run on an easily mined domain 
to occur for longer.
