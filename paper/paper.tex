...
Cryptocurrencies do good, from decentralizing money to finding primes. But they can do bad.

What is being proved is bandwidth to a given endpoint.
Unique challenge regarding priveleged position of owning target server.
What does this means for active engagement as a potential target?

Formalized reliance upon consensus for target-setting is weird

Blockchain forking could enable miner rejection of a target, or rejection of target removal.
This is true of PAY\_TO\_DDOS and adds risk of placing that transaction in your Merkle tree.
...
- Attack websites we own

- Did not publish the full coin

- Bringing to light potential attacks

- Having no alternative cipher suites in TLS 1.3 could be bad before a large committment
