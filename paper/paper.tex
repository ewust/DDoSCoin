...
DDoSCoin adjusts difficulty for a given domain by looking at the past
...
set the difficulty too low, as the DDoS would be ineffective. Also, many coins would be
...
a ``useful'' proof-of-work around. Certainly a DDoS attack it useful to someone,
...
for the site. Having this privileged position allows 
...
malicious behavior, the ethics of this paper are controlled. We only demonstrate a 
