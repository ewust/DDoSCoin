...
To evaluate its performance, we implement our proof-of-DDoS function in 570
lines of C. Our mining code uses libevent~\cite{libevent} and
OpenSSL~\cite{openssl}.

From wifi: 100 concurrent conns, 10k connections total in 53 seconds, 500KB/s
roughly (no CPU load)

TODO: measure from CU...or to a local server?
...
The relatively-short history of cryptocurrency is an exciting one, litered with
mystery 
