...
malicousness inherent to the currency's design.
...
when miners have different bandwidth to a given endpoint at a level beyond their direct 
control. In prior cryptocurrencies, the proof-of-work uses resources entirely under the
miner's control. The extreme of having a unique position to attack a site is being the
target, and having the private key for the site. Having this priveleged position allows 
...
\todo{Talk about TLS 1.3, signing client controlled values}
